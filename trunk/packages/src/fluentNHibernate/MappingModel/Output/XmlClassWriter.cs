...
namespace FluentNHibernate.MappingModel.Output
{
    public class XmlClassWriter : XmlClassWriterBase, IXmlWriter<ClassMapping>
    {
        ...
        public override void ProcessClass(ClassMapping classMapping)
        {
            ...
            if (classMapping.IsSpecified("Catalog"))
                classElement.WithAtt("catalog", classMapping.Catalog);
            
            if (classMapping.IsSpecified("PrimaryKeyName"))
                classElement.WithAtt("primary-key-name", classMapping.PrimaryKeyName);
