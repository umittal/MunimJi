...
namespace NHibernate.Envers.Configuration
{
	public class RevisionInfoConfiguration
	{
		...
		private XmlDocument generateDefaultRevisionInfoXmlMapping()
		{
            ...
            //Mayank: REVINFO table name
            //classMapping.SetAttribute("table", "REVINFO");
            classMapping.SetAttribute("table", _globalCfg.RevisionTableName);
            ...
            //Mayank: REVfield name
            //col.SetAttribute("name", "REV");
            col.SetAttribute("name", _globalCfg.RevisionTableIdFieldName);
            ...
            //Mayank: REVTSTMP field name
            //MetadataTools.AddColumn(timestampProperty, "REVTSTMP", -1, 0, 0, SqlTypeFactory.DateTime.ToString());
            MetadataTools.AddColumn(timestampProperty, _globalCfg.RevisionTableTimestampFieldName, -1, 0, 0, SqlTypeFactory.DateTime.ToString());
