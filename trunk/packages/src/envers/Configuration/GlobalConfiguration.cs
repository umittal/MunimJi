...
namespace NHibernate.Envers.Configuration
{
	public class GlobalConfiguration 
	{
		public GlobalConfiguration(IDictionary<string,string> properties) 
		{
		    ...
		    RevisionTableName = Toolz.GetProperty(properties, ConfigurationKey.RevisionTableName, "REVINFO");
		    RevisionTableIdFieldName = Toolz.GetProperty(properties, ConfigurationKey.RevisionTableIdFieldName, "REV");
            RevisionTableTimestampFieldName = Toolz.GetProperty(properties, ConfigurationKey.RevisionTableTimestampFieldName, "REVTSTMP");
		}
        ...
        /// </summary>
        public string RevisionTableName { get; private set; }
        /// <summary>
        /// The default name of the revision metadata table id field.
        /// </summary>
        public string RevisionTableIdFieldName { get; private set; }
        /// <summary>
        /// The default name of the revision metadata table timestamp field.
        /// </summary>
        public string RevisionTableTimestampFieldName { get; private set; }
